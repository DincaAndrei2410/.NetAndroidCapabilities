...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android_Capabilities.Location.GeolocationListener, Android_Capabilities", GeolocationListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GeolocationListener.class) {
			mono.android.TypeManager.Activate ("Android_Capabilities.Location.GeolocationListener, Android_Capabilities", "", this, new java.lang.Object[] {  });
		}
	}
