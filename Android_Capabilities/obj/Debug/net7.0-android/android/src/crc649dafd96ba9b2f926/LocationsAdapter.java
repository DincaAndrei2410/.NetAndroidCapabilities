...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android_Capabilities.Location.LocationListComponents.LocationsAdapter, Android_Capabilities", LocationsAdapter.class, __md_methods);
	}
	...
	public LocationsAdapter ()
	{
		...
		if (getClass () == LocationsAdapter.class) {
			mono.android.TypeManager.Activate ("Android_Capabilities.Location.LocationListComponents.LocationsAdapter, Android_Capabilities", "", this, new java.lang.Object[] {  });
		}
	}
